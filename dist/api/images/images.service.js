...
var _images = _interopRequireDefault(require("./images.model"));
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _images["default"].sync({
              force: false
            }).then(function () {
              return _images["default"].create(body);
            });
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _images["default"].findAll({
              where: {
                type: type
              }
            });
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _images["default"].destroy({
              where: {
                id_image: id
              }
            });
